...
10. **MCP does not store note bodies on the server.** MCP reads and writes the user’s GitHub repository. Create/update fail until GitHub is connected. Live Obsidian clients get `file_changed` with content.
